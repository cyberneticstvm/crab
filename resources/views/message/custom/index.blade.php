                            ...
                            <table class="" id="advance-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="javascript:void(0)" data-mid="{{ $message->id }}" class="sendCustomMessage" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="fa fa-whatsapp fa-lg text-success"></i></a></td>
            ...
            <div class="modal-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-4">
                        ...
                        {{ html()->select('phone_code', $pcodes, '91')->class('form-control js-example-basic-single1')->placeholder('Select')->required() }}
                        @error('phone_code')
