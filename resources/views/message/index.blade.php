...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3>Message Register (Regular)</h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-sm-10">
                                <h5>Message Register (Regular)</h5>
                            </div>
                            <div class="col-sm-2 text-end dropdown-basic">
                                <div class="dropdown text-start">
                                    ...
                                    <div class="dropdown-content"><a href="{{ route('message.create', 'regular') }}" data-bs-original-title="" title="">Message</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="" id="advance-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $message->title }}</td>
                                        <td class="text-center"><a href="{{ route('wa.message.preview', ['id' => encrypt($message->id), 'type' => 'regular']) }}" target="_blank">Preview</a></td>
