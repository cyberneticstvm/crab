...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3>{{ ($type == 'contributor') ? ucfirst('Well-wisher')  : 'Member' }}</h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>{{ ($type == 'contributor') ? ucfirst('Well-wisher')  : 'Member' }} Create</h5>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    {{ html()->select('phone_code', $pcodes, NULL)->class('form-control js-example-basic-single')->placeholder('Select')->required() }}
                                    @error('phone_code')
                        ...
                        <div class="card-footer text-end">
                            ...
                            <a class="btn btn-secondary" onclick="window.history.go(history.length)">Cancel</a>
                        </div>
                    </div>
                    {{ html()->form()->close() }}
                </div>
