                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    {{ html()->date('dob', $member->dob?->format('Y-m-d'))->class('form-control') }}
                                    @error('dob')
                                    <small class="text-danger">{{ $errors->first('dob') }}</small>
                                    @enderror
                                </div>
                                <div class="col-sm-2">
                                    <label class="col-form-label pt-0 req" for="contributor">Phone Code</label>
                                    {{ html()->select('phone_code', $pcodes, $member->phone_code)->class('form-control js-example-basic-single')->placeholder('Select')->required() }}
                                    @error('phone_code')
                                ...
                                <div class="col-sm-2">
                                    ...
                                    {{ html()->text('mobile', $member->mobile)->class('form-control')->maxlength(15)->placeholder('0123456789') }}
                                    @error('mobile')
                                ...
                                <div class="col-sm-2">
                                    ...
                                    {{ html()->text('adhaar', $member->adhaar)->class('form-control')->maxlength(15)->placeholder('XXXXXXXXXX') }}
                                    @error('adhaar')
