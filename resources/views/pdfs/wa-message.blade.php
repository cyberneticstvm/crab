...
<head>
    ...
    <style>
        ...
        @page {
            background: url("{{ asset('/assets/docs/crab-lh-bg.jpg') }}") no-repeat 0 0;
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <br />
                <br />
                <div class="text-end txt-small">{{ ($message?->wa_msg_id) ? $message->created_at->format('d.M.Y h:i a') : date('d.M.Y h:i a') }}</div>
                ...
                <div class="text-start">
                    <img src="{{ asset('/assets/docs/crab-sign.png') }}" width="50%" />
                </div>
                @endif
            </div>
        </div>
