...
<div class="row receipt">
    ...
    <div class="col">
        ...
        <p class="font-medium ln-h-30"> from Shri/Smt <strong>{{ $donation->member->name }}</strong>, Address <strong>{{ $donation->member->address }}</strong>, PAN/Aadhaar No. <strong>{{ $idno ?? '..........................' }}</strong> as Cash/Cheque/DD (Bank) <strong>{{ $donation->bank_cheque ?? '..........................' }}</strong> dated <strong>{{ $donation->payment_date->format('d.M.Y') }}</strong> towards donation.</p>
    </div>
    <div class="col mt-10">
